		...
		<Layout>
			...
			<article className={styles.article}>
				<section className={styles.desc}>
					...
					<p>
						あのあまりに有名な「さくら」さんより二年ほど前に名づけられた昔日のウェブ屋。兄はいるが寅さんではなく、柴又ではなく中野で生まれた。<br />
				...
				<section className={styles.design}>
					...
					<p>
						私は設計がいちばん好きなので、ヒアリングの「聴く耳」がもっとも大切な根幹部分かなと思っています。<br />
						Webサイトは、企業や個人のアイデンティティーを第三者に向けて「客観的に」表現する場なので、その人も知らなかったその人の魅力、「本質」を映し出す良き媒体でありたいと考えています。
					</p>
					<hr />
					<p>
